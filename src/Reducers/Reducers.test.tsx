...
describe('reducers test', () => {
    ...
    it ('should handle start game action', () => {
        expect(gameReducer(undefined, {type: GAME_ACTION.MAKE_MOVE, payload: {cell: [0,0]}})).toEqual(
            {
    ...
    it ('should handle move action', () => {
        ...
        expect(gameReducer(initialState, {type: GAME_ACTION.MAKE_MOVE, payload: {cell}})).toEqual(
            {
                board: {[[0,0].toString()]: EValue.X, [[cell[0], cell[1]].toString()]: EValue.O},
                turn: EValue.X,
                hasWinner: false
            }
        )
    ...
    it ('should find winner', () => {
        ...
        expect(gameReducer(initialState, {type: GAME_ACTION.MAKE_MOVE, payload: {cell}})).toEqual(
            {
                board: {...initialState.board, [[cell[0], cell[1]].toString()]: EValue.X},
                turn: EValue.X,
                hasWinner: true
            }
        )
